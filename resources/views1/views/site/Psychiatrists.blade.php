      ...
      <div class="bread-crumb-wrap ibc-wrap-4">
          <div class="container">
              ...
              <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
                  <div class="bread-heading"><h1>Psychiatrists Registration</h1></div>
                  <div class="bread-crumb pull-right">
                      <ul>
                          <li><a href="index.html">Home</a></li>
                          <li><a href="about-us.html">Psychiatrists Registration</a></li>
                      </ul>
                  </div>
              </div>
          </div>
                  ...
                  <div class="col-xs-12 col-lg-12 col-sm-12 col-md-12 pull-left no-pad">
                      ...
                      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 no-pad wow fadeInUp" data-wow-delay="0.5s" data-wow-offset="160">
                          ...
                          <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 no-pad">
                              ...
                              <form method="POST" action="{{route('add_psychiatrists')}}" enctype="multipart/form-data" class="contact2-page-form col-lg-12 col-sm-12 col-md-12 col-xs-12 no-pad contact-v1" id="">
                                @csrf
